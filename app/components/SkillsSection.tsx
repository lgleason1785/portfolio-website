  ...
  return (
    <div className="relative z-10 py-16 sm:py-24 bg-[#0a0a0a]" id="about">
      <div className="space-y-4 mb-10">
        <h1
          className="text-3xl min-[430px]:text-4xl md:text-5xl font-bold text-[#E29211]"
        >
          My Tech Stack
        </h1>
        <p
          className="text-sm min-[430px]:text-base max-w-lg md:max-w-3xl text-white/70"
        >
      ...
      <div
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 max-w-6xl mx-auto"
      >
