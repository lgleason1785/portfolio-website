...
const TechCard = ({
  ...
  const cardContent = (
    <div className="flex gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border border-[#333333] bg-[#111111] hover:bg-[#1a1a1a] hover:border-[#444444] transition-colors duration-200 cursor-pointer group">
